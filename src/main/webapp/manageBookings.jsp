                    ...
                    <li class="nav__item">
                        <form action="/roomy/edit" method="post" class="centered">
                            ...
                            <% if (calendar[i][1].equals(calendar[i][0])) { %>
                                <input type="submit" value="<%= calendar[i][1] %>, der <%= calendar[i][2] %>" class="calendarbutton" disabled>
                            <% } else { %>
                                <input type="submit" value="<%= calendar[i][1] %>, der <%= calendar[i][2] %>" class="calendarbutton">
                            <% } %>                            
                        </form>
                    </li>
                    <% } %>
